...
<div id="wrapper">
    ...
    <div class="content-holder scroll-content" data-pagetitle="Portofolio Single">
        ...
        <div class="fixed-column-wrap">
            ...
            <div class="fixed-column-tilte fcw-title"><span>Project title</span></div>
        </div>
            ...
            <div class="content">
                ...
                <div class="fixed-top-panel fl-wrap">
                    <div class="sp-fix-header fl-wrap">
                        ...
                        <a href="portfolio.html" class="ajax back-to-home-btn"><span>Back to portfolio</span></a>
                    </div>
                </div>
                <!--fixed-top-panel end-->
                <!--section -->
                <section   class="hidden-section">
                    ...
                    <div class="container">
                        ...
                        <!-- portfolio start -->
                        <div class="gallery-items min-pad  lightgallery   fl-wrap  bot-element">
                            @foreach ($project->imagenes as $image)
                            <div class="gallery-item">
                                <div class="grid-item-holder hov_zoom">
                                    <img src="{{ Voyager::image($project->getThumbnail($image, 'cropped')) }}" alt="">
                            ...
                            <div class="footer-box-item fl-wrap">
                                ...
                                <div class="subcribe-form fl-wrap">
                                    <form id="subscribe" class="fl-wrap">
                                        ...
                                        <button type="submit" id="subscribe-button" class="subscribe-button color-bg"><i class="fal fa-paper-plane"></i> Send </button>
